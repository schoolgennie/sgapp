      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="row">
            <div class="col-sm-12">
              <div class="panel panel-default">
                <div class="panel-heading"> <i class="clip-pie"></i> Messages
                  <div class="panel-tools"> <a class="btn btn-xs btn-link panel-close" href="#"> <i class="fa fa-times"></i> </a> </div>
                </div>
            ...
            <div class="panel-body panel-scroll" style="height:300px">
              <table class="table table-striped table-hover" id="sample-table-1">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="center"><img src="<?=($facultyValue->faculty_image)?createImazeSize(get_small('faculty'),$facultyValue->faculty_image,30,30):'design/images/avatar-2.jpg'?>" alt="image"/> </td>
                    <td><?=$facultyValue->faculty_first_name.' '.$facultyValue->faculty_last_name?></td>
                    <td><span class="label label-info">
                      <?=$facultyValue->subject_name?>
                      </span> </td>
                  ...
                  <? else:?>
                  <tr>
                    <td colspan="4"><h2>No Faculty.</h2></td>
                  </tr>
                  <? endif;?>
                </tbody>
              </table>
