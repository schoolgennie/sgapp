									...
									<table class="table table-bordered " id="">
										...
										<tbody>
											...
											<tr>
											    ...
											    <? foreach($weekDaysArray as $keyWeekDays=>$valueWeekDays):?>
                                                <td><?=(getDataForFacultyOfActiveTimeTable($faculty_id,$activeTimeTable->time_table_id,$activeTimetablePeriodListValue->time_table_period_id,$keyWeekDays))?getDataForFacultyOfActiveTimeTable($faculty_id,$activeTimeTable->time_table_id,$activeTimetablePeriodListValue->time_table_period_id,$keyWeekDays)->subject_name.' <span class="label label-info "> '.getDataForFacultyOfActiveTimeTable($faculty_id,$activeTimeTable->time_table_id,$activeTimetablePeriodListValue->time_table_period_id,$keyWeekDays)->class_name.' </span>':'';?></td>
                                                <? endforeach;?>
											</tr>
                                            <? endforeach;?>
