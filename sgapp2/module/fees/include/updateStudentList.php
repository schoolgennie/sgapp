      ...
      <?  foreach($studentList as $studentListKey=>$studentListValue):?>
        <tr>
            ...
            <div class="checkbox-table">
             <input type="checkbox"  class="flat-green" name="student_id[<?=$v->fee_structure_id?>][]" value="<?=$studentListValue->student_id?>" <?=in_array($studentListValue->student_id,feeCollectionManagementtList($v->fee_structure_id))?'checked="checked"':'';?>>
            </div>
            </td>
            <td class="center">
