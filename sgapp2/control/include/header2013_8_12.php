...
<li <?php css_active($Page, 'registrationType', 'active');?>><span><span><a href="<?php echo make_admin_url('registrationType', 'list', 'list');?>">Registration Types</a></span></span></li>
 ...
 <li <?php css_active($Page, 'video', 'active');?>><span><span><a href="<?php echo make_admin_url('video', 'list', 'list');?>">Video</a></span></span></li>
  <li <?php css_active($Page, 'learningCenter', 'active');?>><span><span><a href="<?php echo make_admin_url('learningCenter', 'list', 'list');?>">Learning Center</a></span></span></li>           
  <li <?php css_active($Page, 'permissions', 'active');?>><span><span><a href="<?php echo make_admin_url('permissions', 'list', 'list');?>">Paywall</a></span></span></li>            			
