...
<form action="<?=make_admin_url('home_banner', 'list_ops', 'list', 'id='.$id)?>" method="post">
  <table width="100%" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;" class="table">
    ...
    <tr>
      <td colspan="9"  style="border-top:solid 1px #dcdcdc;"><?=PageControl($QueryObj->PageNo, $QueryObj->TotalPages, $QueryObj->TotalRecords, DIR_WS_SITE_CONTROL.'control.php', 'Page=home_banner', 2);?></td>
    </tr>
  </table>
  <br/>
  <table width="100%" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;" class="table">
    <tr>
      ...
      <td width="18%" class="table_head" align="left">Image</td>
      <td width="17%" class="table_head" align="center">Active</td>
      <td width="22%" colspan="2" align="center" class="table_head">Controls</td>
    </tr>
  </table>
  <br/>
  <table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;" id="zebra" class="table">
    ...
    <tr id="<?php $QueryObj1->id?>">
      <td width="6%" align="center" valign="middle"><?=$sr++;?>
        .</td>
      <td width="17%" align="left"><img src="<?=get_large('home_banner',$QueryObj1->image);?>" width="172px"/></td>
      <td width="17%" align="center" style="padding-left:5px;"><label id="<?=$QueryObj1->id?>a">
        <input type="radio" name="status[<?=$QueryObj1->id?>]" value="1" <?=($QueryObj1->is_active==1)?'checked':'';?>>
        Y</label>
        &nbsp;&nbsp;
        <label id="<?=$QueryObj1->id?>d">
        <input type="radio" name="status[<?=$QueryObj1->id?>]" value="0" <?=($QueryObj1->is_active==0)?'checked':'';?>>
        N</label>
      </td>
      <td width="11%" align="center"><?=make_admin_link(make_admin_url('home_banner', 'update', 'update', 'id='.$QueryObj1->id), get_control_icon('edit'));;?></td>
      <td width="11%" align="center"><?=make_admin_link(make_admin_url('home_banner', 'delete', 'list', 'id='.$QueryObj1->id), get_control_icon('cancel'));?></td>
    </tr>
    <?endwhile;?>
    <tr>
      ...
      <td width="11%" colspan="2"  style="border-top:solid 1px #dcdcdc;">&nbsp;</td>
    </tr>
  </table>
</form>
<?
	...
	case 'insert':
		#html code here.
		?>
<form id="new_product" action="<?=make_admin_url('home_banner', 'insert', 'list');?>" method="post" name="new_product" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;" >
    <tr>
      <td colspan="2" align="left"><?=make_admin_link(make_admin_url('home_banner', 'list', 'list', 'id='.$id), 'Back to banner listing')?></td>
    </tr>
    <tr>
      <td colspan="2" align="center" class="table_head">Add New Banner</td>
    </tr>
    <tr>
      <td width="17%" align="left">Image</td>
      <td width="83%" align="left"><input type="file" name="image"  /></td>
    </tr>
    <tr>
      <td width="17%" align="left"></td>
      <td width="83%" align="left">You must upload a banner 991*295 pixels</td>
    </tr>
    <tr>
      <td width="17%" align="left">Text</td>
      <td width="83%" align="left"><textarea name="description" cols="50" rows="5"></textarea></td>
    </tr>
    <!-- <tr>
					<td width="17%" align="left">URL</td>
					<td width="83%" align="left"><input type="text" name="url"  /></td>
                    </tr> -->
    <tr>
      <td width="17%" align="left">Status</td>
      <td width="83%" align="left"><input type="checkbox" name="is_active" value="1" /></td>
    </tr>
    <tr>
      <td width="17%" align="left"></td>
      <td width="83%" align="left"><input type="submit" name="new_banner" value="Submit" tabindex="9" /></td>
    </tr>
  </table>
</form>
<?
	...
	case 'update':
		#html code here.
		?>
<form id="new_product" action="<?=make_admin_url('home_banner', 'update', 'list', 'id='.$id);?>" method="post" name="new_product" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="2" cellpadding="2" style="border:solid 1px #dcdcdc;">
    <tr>
      <td colspan="2" align="left"><?=make_admin_link(make_admin_url('home_banner', 'list', 'list'), 'Back to banner  listing')?></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="82%" align="left"><input type="file" name="image"  />
        <img src="<?=get_large('home_banner',$product->image)?>" width="172"/></td>
    </tr>
    <tr>
      <td width="18%" align="left"></td>
      <td width="82%" align="left">You must upload a banner 991*295 pixels</td>
    </tr>
    <tr>
      <td width="17%" align="left">Text</td>
      <td width="83%" align="left"><textarea name="description" cols="50" rows="5"><?=$product->description?>
</textarea></td>
    </tr>
    <tr>
      <td width="18%" align="left">Status</td>
      <td width="82%" align="left"><input type="checkbox" name="is_active" <?=($product->is_active)?'checked':''?>/></td>
    </tr>
